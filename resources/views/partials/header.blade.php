    ...
    <nav class="flex flex-row items-center space-between w-full">
        ...
        {{-- <el-dropdown class="inline-block">
            ...
            <el-menu anchor="bottom end" popover class="w-56 origin-top-right divide-y divide-white/10 rounded-md bg-gray-800 outline-1 -outline-offset-1 outline-white/10 transition transition-discrete [--anchor-gap:--spacing(2)] data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in">
                <div class="py-1">
                    <a href="/profile" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-hidden">View Profile</a>
                ...
                <div class="py-1 cursor-pointer">
                    <form method="POST" action="{{ route('logout') }}" class="w-full cursor-pointer block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-hidden">
                        @csrf
        ...
        <section class="bg-dark">
            <div class="container">
                ...
                >
                    ...
                    class="item-bg absolute right-0 top-[120%] w-60 divide-y divide-stroke overflow-hidden rounded-lg divide-dark-3 bg-dark-2"
                    >
                    <div>
                        <a
                            href="/profile"
